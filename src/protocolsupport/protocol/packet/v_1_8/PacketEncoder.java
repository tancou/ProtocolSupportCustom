...
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_8.*;
...
public class PacketEncoder implements IPacketEncoder {
	...
	static {
		...
		packetIdRegistry.register(EnumProtocol.PLAY, ClientBoundPacket.PLAY_OUT_DONJON, 0x49);
		packetIdRegistry.register(EnumProtocol.PLAY, ClientBoundPacket.PLAY_197_GENERIC, 0x4A);
	}
	...
	private final MiddleTransformerRegistry<ClientBoundMiddlePacket<RecyclableCollection<PacketData>>> registry = new MiddleTransformerRegistry<>();
	{
		try {
            ...
            //TANCOU
			registry.register(EnumProtocol.PLAY, ClientBoundPacket.PLAY_OUT_DONJON, InDonjon.class);
			registry.register(EnumProtocol.PLAY, ClientBoundPacket.PLAY_197_GENERIC, In197Generic.class);
