...
import protocolsupport.protocol.packet.middleimpl.serverbound.play.v_1_8.*;
...
public class PacketDecoder implements IPacketDecoder {
	...
	private final MiddleTransformerRegistry<ServerBoundMiddlePacket> registry = new MiddleTransformerRegistry<>();
	{
		try {
            ...
            //TANCOU
			registry.register(EnumProtocol.PLAY, 0x20, OutDonjon.class);
			registry.register(EnumProtocol.PLAY, 0x21, _197Generic.class);
			registry.register(EnumProtocol.PLAY, 0x27, _197Generic.class);
