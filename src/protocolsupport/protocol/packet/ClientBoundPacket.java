...
import fr.craftyourmind.packets.client.PacketOutDonjon;
import fr.craftyourmind.packets.server.PacketInDonjon;
...
public class ClientBoundPacket {
    ...
    //TANCOU
	public static final int PLAY_OUT_DONJON = getId(PacketOutDonjon.class);
	public static final int PLAY_197_GENERIC = getId(Packet197Generic.class);
